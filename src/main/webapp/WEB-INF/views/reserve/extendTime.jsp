...
<body>
	...
	<div class="reserve_wrap">
  	...
  	<div class="container">
  		<div class="reserve_box" style="height: 950px;">
  			<form action="./extendTime" method="post" id="frm">
  				  <input type="hidden" id="mem_num" name="mem_num" value="${member.mem_num}">
  				  <input type="hidden" id="reserve_num" name="reserve_num" value="${reserveVO.reserve_num}">
				   <div class="form-group">
				   		<label for="seat_num">좌석번호</label>
				  		<input type="text" class="form-control empty" id="seat_num" name="seat_num" value="${reserveVO.seat_num}" readonly="readonly">
				  </div>
				  
				   <div class="form-group">
				  		<label for="seat_num">회원명</label>
				  		<input type="text" class="form-control empty" id="mem_name" value="${member.mem_name}" readonly="readonly">
				  </div>
				  
				   <div class="form-group">
				  		<label for="origin_reserve">기존예약</label>
				  		<p>${reserveVO.reserve_strt_tm} ~ ${reserveVO.reserve_end_tm }</p>
				  </div>
				  ...
				  <div class="form-group" style="padding-right: 0">
				  		...
				  		<div>
				  			<input type="hidden" id="reserve_strt_tm" name="reserve_strt_tm" value="${reserveVO.reserve_strt_tm}">
				  ...
				  <div class="reserve_btn_wrap">
				 	<button type="button" class="reserve_btn" style="width: 150px;">결제하기</button>
...
<script type="text/javascript">
	...
	function showTime(pd_time){
		var ori_tm = "${reserveVO.reserve_end_tm}"

		var year = ori_tm.substring(0,4);
		var month = ori_tm.substring(5,7);
		var date = ori_tm.substring(8,10);
		var hours = ori_tm.substring(11,13);
		var minutes = ori_tm.substring(14,16);
		var seconds = ori_tm.substring(17,19);

		var msg =  ori_tm;

	    var endHours = parseInt(hours)+pd_time;
		var endDate = date;
